...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/home/oleg/dev/sites/drupal/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
}
